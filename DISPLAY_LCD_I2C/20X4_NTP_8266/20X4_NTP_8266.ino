...
#include <LiquidCrystal_I2C.h>      //0X27 BIG NUMBER   20X4
LiquidCrystal_I2C lcd(0x3F,20,4);   //0x3F AZUL PEQUENO 20X4
...
const int timeZone = -3;    // Brasil -2 com horario verao
